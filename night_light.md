...
##### MCU
The basis of this project is "breadboardability" to allow for experimentation and mistakes. So we chose the ESP32-WROOM32 dev board for its pin mounting, as well as the built-in antenna, regulator, low-power modes, and ease of programming via USB-C.
...
The V~CC~ in the circuit comes from the LOAD pins of the charger, and should be 3.7V when the battery is nearly  full.
...
### Results
This is a picture Kano took from Armenia after she helped the students design the enclosures.<br>
